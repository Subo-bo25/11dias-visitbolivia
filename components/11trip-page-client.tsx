/**
 * Visit Bolivia 11-Day Package - Main Trip Component
 * =================================================
 * 
 ...
 * 
 * Description:
 * Main client-side component for the 11-day Bolivia travel package showcase.
 * Features multi-language support, interactive UI elements, review system,
 * image galleries, and WhatsApp integration. 867 lines of complex React logic.
 */

"use client"

import { useState, useEffect, useRef, useMemo } from "react"
import type { TripData } from "./11trip-data-es"
...
interface TripPageClientProps {
  ...
  imagesData: {
    package_id: string;
    images: Array<{id: number; url: string; category: string; alt_text: string; alt_text_en?: string}>;
    total_images: number;
        ...
        <div className="flex items-center justify-center flex-wrap gap-x-4 text-gray-600 font-bold py-6 bg-[#f5f5f5]">
          ...
          {reviewsLoading ? (
            ...
            <>
              ...
              <span className="text-gray-600">•</span>
              <a
                href={`#${sectionMap.reviews.replace(/ /g, "-")}`}
                onClick={(e) => {
                  e.preventDefault()
        ...
        {imagesLoading ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 h-[400px] md:h-[500px] mb-1">
            <div className="col-span-2 row-span-2 bg-gray-200 animate-pulse rounded-lg flex items-center justify-center">
              <span className="text-gray-500 text-lg">Cargando imágenes...</span>
            </div>
            ...
            <Dialog>
              ...
              <div className="flex justify-end px-4">
                <DialogTrigger asChild>
                  <Button variant="secondary" className="text-lg text-white">
                    Ver todas las imágenes ({getAllImages().length})
                  </Button>
                </DialogTrigger>
              </div>
              <DialogContent className="max-w-4xl">
                <DialogHeader>
                  <DialogTitle>Fotos del Viaje</DialogTitle>
                </DialogHeader>
        ...
        {tripData.navLinks.map((link) => {
          ...
          return (
            ...
            >
              ...
              {(link === sectionMap.overview) && (
                <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    {tripData.overview.facts
                      .filter(fact => fact.label !== "Puntuación física" && fact.label !== "Physical score")
                      .map((fact) => (
              ...
              {/* 5. Por qué te encantará este tour / Why you'll love this tour */}
              {(link === sectionMap.whyLove) && (
                <div className="py-8 px-2.5 bg-[#f5f5f5]">
                  <div className="grid lg:grid-cols-3 gap-x-8 items-start">
                    ...
                    <div className="lg:col-span-2 grid md:grid-cols-2 gap-x-8">
                      {/* Second column */}
                      <ul className="space-y-2 list-disc pl-5">
                        {tripData.whyYoullLoveThis
                  ...
                  <div className="lg:col-span-3">
                    <div className="flex justify-end mb-4">
                      <Button variant="secondary" onClick={toggleAllItinerary}>
                        {openAccordionItems.length === itineraryData.itinerary.length ? (isEnglish ? "View less" : "Ver menos") : (isEnglish ? "View all" : "Ver todo")}
                      </Button>
                    </div>
                    {itineraryLoading ? (
              ...
              {/* 7. Inclusiones/Included */}
              {(link === sectionMap.included) && (
                <div>
                  <h2 className="text-3xl font-bold mb-4">{link}</h2>
              ...
              {/* 8. ¿Es este tour para ti? / Is this tour for you? */}
              ...
              {/* 9. Empieza tu aventura / Start your adventure */}
              ...
              {/* 10. Notas importantes / Important notes */}
              ...
              {(link === sectionMap.reviews) && (
                <div>
                  <div className="flex flex-wrap items-center gap-x-4 gap-y-2 mb-6">
                    ...
                    <span>{reviewStats.total} {isEnglish ? "reviews" : "reseñas"}</span>
                  </div>
                  <div className="grid lg:grid-cols-4 gap-8">
                    <div className="lg:col-span-1">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center gap-3 md:gap-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center text-center sm:text-left">
            ...
            <span className="text-sm md:text-2xl font-semibold text-gray-700">
              {isEnglish ? "From" : "Desde"} USD {formatNumber(tripData.price.from)}
            </span>
          </div>
