...
export default function TestPage() {
  ...
  const runTests = async () => {
    ...
    const tests = [
      ...
      { name: 'Reviews API', endpoint: `${API_BASE_URL}/api/reviews/11days` },
      { name: 'Images API', endpoint: `${API_BASE_URL}/api/images/11days` },
      { name: 'Itinerary API (ES)', endpoint: `${API_BASE_URL}/api/itinerary/11days?lang=es` },
      { name: 'Itinerary API (EN)', endpoint: `${API_BASE_URL}/api/itinerary/11days?lang=en` },
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-gray-900">API Test Page - 11 Days Package</h1>
