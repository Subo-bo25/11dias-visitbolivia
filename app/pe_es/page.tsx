...
import { tripData, fetchReviews, fallbackReviews, fetchImages, fetchItinerary, fallbackItinerary, ReviewsResponse, ImagesResponse, ItineraryResponse } from "@/components/11trip-data-es"
import { TripPageClient } from "@/components/11trip-page-client"

export default function TripPageES() {
  ...
  const getImagesComponent = () => {
    ...
    if (errorStates.images) {
      return {
        ...
        total_images: 0,
        isError: true,
        errorMessage: "No se pudieron cargar las imágenes en este momento"
      }
    }
