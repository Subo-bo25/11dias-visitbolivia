...
import { tripData, fetchReviews, fallbackReviews, fetchImages, fetchItinerary, fallbackItinerary, ReviewsResponse, ImagesResponse, ItineraryResponse } from "@/components/11trip-data-en"
  ...
  const getImagesComponent = () => {
    ...
    if (errorStates.images) {
      return {
        ...
        total_images: 0,
        isError: true,
        errorMessage: "Could not load images at this time"
      }
    }
